...
class Oschadpay_OschadpayOnPage_Block_Response extends Mage_Core_Block_Abstract
{
    ...
    protected function _toHtml()
    {
        ...
        $fodny = Mage::getModel('OschadpayOnPage/OschadpayOnPage');
        ...
        try {
            $validated = OschadpayForm::isPaymentValid($settings, $_POST);

            if ($validated === true) {
            //if ($_POST[])

                list($orderId,) = explode(OschadpayForm::ORDER_SEPARATOR, $_POST['order_id']);
