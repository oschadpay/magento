 ...
 */
class Oschadpay_OschadpayOnPage_PaymentController extends Mage_Core_Controller_Front_Action
{
    ...
    Mage_Core_Controller_Varien_Action::_redirect('OschadpayOnPage/payment/response', array('_secure' => false, '_query'=> $arr_querystring));
    }
    }
